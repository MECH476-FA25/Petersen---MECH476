...
ppm_and_time <- read_csv("C:/Users/Vance/OneDrive - Colostate/Desktop/Petersen---MECH476/data/ftc_o3.csv") %>% dplyr::select(sample_measurement, datetime) %>% filter(!is.na(sample_measurement), !is.na(datetime))
```
...
```{r missing-data}
# examine tibble
is imported and manipulated properly
