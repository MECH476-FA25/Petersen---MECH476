...
# XL: Good job! Since the legends of the three plots are the same. You can only include one legend. It would be great to highlight the unit of the x axis is thousand dollar (k).
...
# XL: It would be nice to plot your observed data on the same plot.
